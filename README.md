About xorg-libxfixes-feedstock
==============================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/xorg-libxfixes-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/xorg-libxfixes-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add xorg-libxfixes
# for installing globally
pixi global install xorg-libxfixes
```
...
It is possible to list all of the versions of `xorg-libxfixes` available on your platform:
...
```
pixi search xorg-libxfixes --channel conda-forge
```
